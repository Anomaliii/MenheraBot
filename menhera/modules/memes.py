...
import menhera.modules.helper_funcs.fun_strings as fun
from menhera import DEV_USERS, LOGGER, SUDO_USERS, SUPPORT_USERS, dispatcher
from menhera.modules.disable import (
...
DECIDE_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(menhera)"), decide, friendly="decide", run_async=True
)
