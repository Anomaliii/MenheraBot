...
import menhera.modules.no_sql.gban_db as gban_db
from menhera import STRICT_GBAN  # LOGGER,
from menhera import (
    DEV_USERS,
    GBAN_LOGS,
    OWNER_ID,
...
from menhera.modules.helper_funcs.alternate import (
    send_action,
    send_message,
    typing_action,
)
from menhera.modules.helper_funcs.chat_status import is_user_admin, user_admin
from menhera.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from menhera.modules.helper_funcs.filters import CustomFilters
from menhera.modules.no_sql.users_db import get_all_chats
