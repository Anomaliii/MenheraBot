...
*Managed With ❤️ By :* [Anomaliii](https://t.me/Anomaliii)
...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to Group 👥", url="t.me/MenheraChwan_Bot?startgroup=true"
        ),
        InlineKeyboardButton(
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                "https://telegra.ph/file/f8783a9962758775dc8ec.jpg",
                PM_START_TEXT,
